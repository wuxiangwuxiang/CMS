		...
		<form style="float: left; width: 80%;"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input id="id" value="<%=request.getParameter("studentRoNo") %>" type="text" name="studentRoNo" required
						lay-verify="required|number|idvalidate" readonly="readonly"
	...
	<script>
		...
		function trySubmit(id) {
			...
			$.ajax({
	              ...
	              async: false,
	              dataType: "json",
	              url: "<%=request.getContextPath()%>/student/ajaxupdateStudentPassWord.do",
